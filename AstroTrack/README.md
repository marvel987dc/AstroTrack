...
🚀 Features
🔭 Celestial Object Browser: View planets, stars, and exoplanets with scientific data.
...
🧠 How It Works
Fetch Celestial Data from the Supabase database.
...
bash
Copy code
git clone  https://github.com/marvel987dc/AstroTrack.git
cd astrotrack
